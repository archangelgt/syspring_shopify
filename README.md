...
6. **Drawer / página carrito:** activa el App embed **SYSPRICING cart B2B**, o pega `snippets/syspricing-cart-boot.liquid` en `theme.liquid` (el grid de colección ya carga el JS).
